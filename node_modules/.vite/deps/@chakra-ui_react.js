    ...
    if (!isStatic && isBrowser2) {
      ...
      if (context.visualElement) {
        features = context.visualElement.loadFeatures(
          ...
          configAndProps,
          (0, import_react20.useContext)(LazyContext).strict,
          preloadedFeatures,
          projectionId,
...
function useFocusGesture({ whileFocus, visualElement }) {
  const isFocusActive = (0, import_react26.useRef)(false);
...
function useTapGesture({ onTap, onTapStart, onTapCancel, whileTap, visualElement, ...props }) {
  ...
  const startAccessiblePress = (0, import_react29.useCallback)(() => {
